...
function AddRoomPage() {
    ...
    const addRoom = async (e: React.FormEvent) => {
        ...
        try {
            // Will need to check if it creates a new id
            const response = await axiosInstance.put(`/rooms/`, payloadToSend,
    ...
    return (
        <>
            ...
            <main className={editPageStyle.main}>
                <form onSubmit={addRoom} className={editPageStyle.editForm}>
